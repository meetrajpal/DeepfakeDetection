...
export default function LandingPage() {
  return (
    <main
      className="main"
      style={{
        "background-image": `url('https://images.unsplash.com/photo-1736430043488-0c369959a5c6')`,
    ...
    >
      <section id="hero" className="hero section">
        ...
        >
          ...
          >
            Our advanced AI technology helps you identify manipulated images and
            videos with high accuracy. Protect yourself from digital deception.
          </p>
